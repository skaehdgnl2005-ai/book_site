      ...
      <main>
        <section className="section" aria-labelledby="faq-title">
          ...
          <div className={styles.list}>
            ...
            <FaqItem q="환불이 되나요?">
              {/* F067 — 법정 기준(7일 철회·3영업일 환급) + 주문제작 제한을 요약하고 정책
                  페이지로 연결한다. (F027의 '준비 중' TODO 해소 — 기준값은 전자상거래법.) */}
              주문하신 책은 아이만을 위해 새로 만드는 주문 제작 상품이라, 제작이 시작되기 전에는
              언제든지 취소하실 수 있지만 제작이 시작된 뒤에는 청약철회가 제한됩니다. 취소가
              확정되면 3영업일 이내에 결제하신 수단으로 환급해 드립니다. 자세한 내용은{" "}
              <Link href="/refund-policy">청약철회·환불 정책</Link>을 확인해 주세요.
            </FaqItem>
          </div>
